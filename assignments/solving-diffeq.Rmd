...
Write the system of differential equations that describes figure above.  There will be an equation for each stock and use the flux names to write the balance equation for each stock.
